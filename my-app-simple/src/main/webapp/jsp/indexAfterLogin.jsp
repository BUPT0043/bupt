...
.navbar-form .form-control, .navbar-form .input-group-addon,
	.navbar-form .btn, .navbar-form .select2-search input[type="text"] {
	height: 35px;
	padding: 10px 10px;
	font-size: 15px;
	line-height: 1.4;
				...
				<div class="tile">
					...
					<form class="navbar-form navbar-left" method="post"
						...
						<input type="hidden" name="title" value="${title}"
							class="form-control"> <a href="<%=basePath%>/message/show"
							class="btn btn-primary btn-lg">在线交流</a>
						<input type="hidden" name="title" value="${title}"
							class="form-control"> <a href="<%=basePath%>/contract/chose"
							class="btn btn-primary btn-lg">生成合同</a>
						<button type="submit" class="btn btn-primary btn-lg">案例查询</button>
						</a>
					</form>
				</div>
			</div>
