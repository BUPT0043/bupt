	...
	<body class="login-edit" background="../images/1.jpg";>
	 ...
	 <!--幕区  -->
      <div class="jumbotron">
       ...
       <div class=backgd style="width: 1030px;height: 1000px;background-color: white;">
	       <div class=backup style="width:1030px; height:70px;background-color: white;">
				   ...
				   <div>
				      <form class="navbar-form navbar-left" method="post" action="<%=basePath%>/show/search" role="search">
				         <div class="form-group">
				            <input type="text" name="title" value="${title}"  class="form-control" id="lalainput" placeholder="请输入查询关键字">
				         </div>
			...
			<input type="hidden" id="total" value="${total }" />
       		<div class=backdown style="width:900px; height:50px;background-color: white;">
	       		<p id="pagecontent">
	       			<c:forEach items="${matter }" var="m">
	       				<a href="<%=basePath%>/show/searchresult?id=${m.id}" class="list-group-item" >
       			...
       			$.ajax({
       				...
       				success:function(data){
       					...
       					$.each(data,function(index,obj){
       						console.info(obj);
       						listHtml+='<a href="<%=basePath%>/show/searchresult?id='+obj['id']+'" class="list-group-item" >'+
       							obj['title']+'</a>';
       					});
